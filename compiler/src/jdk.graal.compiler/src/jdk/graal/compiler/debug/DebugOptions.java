...
public class DebugOptions {
    ...
    @Option(help = "Enable debug output for entry point code generation.", type = OptionType.Debug)
    public static final OptionKey<Boolean> DebugValhallaEntryPoints = new OptionKey<>(false);
    // @formatter:on
