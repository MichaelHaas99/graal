...
public class PointerEqualsNode extends CompareNode implements Canonicalizable.BinaryCommutative<ValueNode> {
    ...
    public static class PointerEqualsOp extends CompareOp {
        ...
        private static boolean isAlwaysFailingEqualityTest(CanonicalCondition condition, ValueNode originalX, ValueNode originalY, ValhallaOptionsProvider valhallaOptionsProvider) {
            ...
            if (StampTool.canBeInlineType(originalX.stamp(NodeView.DEFAULT), valhallaOptionsProvider) && StampTool.canBeInlineType(originalY.stamp(NodeView.DEFAULT), valhallaOptionsProvider)) {
                return false;
            }
