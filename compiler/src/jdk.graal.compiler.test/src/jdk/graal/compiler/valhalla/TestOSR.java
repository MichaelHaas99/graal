...
import jdk.graal.compiler.hotspot.test.GraalOSRTestBase;
...
public class TestOSR extends GraalOSRTestBase{
    ...
    public void testOSR01() {
        testOSR(getInitialOptions(), "test35",null,  MyValue2.createDefaultInline(), 3);
    }

    // @Test
     public static ReturnValue test35(MyValue2 vt, int i1) {
         ...
         for (int i = 0; i < 10_000; ++i) {
             ...
             GraalDirectives.blackhole(result);
             result += i1;
